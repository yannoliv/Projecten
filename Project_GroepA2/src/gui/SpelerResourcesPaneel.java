    ...
    public void maakResourcePaneel()
    {
        for (int i = 0; i < dc.getSpelerLijst().size(); i++) {
            ...
            hbox.getChildren().addAll(
                    lbl_punten,lbl_spelerNaam,
                    lbl_stamleden, lbl_voedsel, lbl_gereedschap, lbl_akkerbouw,
                    lbl_hout, lbl_leem, lbl_steen, lbl_goud
            );
...
//            }
////            hbox.setMinWidth(Integer.MAX_VALUE - 1);
////            hbox.setMaxWidth(Integer.MIN_VALUE + 1);
